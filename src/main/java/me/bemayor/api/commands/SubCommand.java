...
public class SubCommand {
    ...
    public Consumer<CommandInputEvent> getAction() {
        return cmdAction;
    }

    public void setAction(Consumer<CommandInputEvent> newAction) {
        cmdAction = newAction;
    }

    public boolean hasAction() {
        return cmdAction != null ? true : false;
    }

    public Function<CommandInputEvent, List<String>> getTabFind() {
        return cmdTab;
    }

    public void setTabFind(Function<CommandInputEvent, List<String>> newTabFind) {
        cmdTab = newTabFind;
    }

    public boolean hasTabFind() {
        return cmdTab != null ? true : false;
    }
