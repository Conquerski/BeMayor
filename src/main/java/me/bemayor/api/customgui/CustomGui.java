...
public abstract class CustomGui {
    ...
    public CustomGui(String guiTitle,String guiDescription,String closeText, int...rowNums) {
        ...
        if(itemNum>4){rowNum=6;}else{rowNum=itemNum+2;}
    ...
    public int getMaxItemNum() { return itemNum; }

    public String getDescription() { return description; }
    public void setDescription(String newDescription) { description=newDescription; }
    public String getCloseText() { return text; }
    public void setCloseText(String newCloseText) { text=newCloseText; }

    private ItemStack getItemStack(InventoryClickEvent event){ return event.getCurrentItem(); }
    private boolean hasItemStack(InventoryClickEvent event){ return getItemStack(event)!=null; }

    public void open(Player player) { gui.open(player); }
    ...
    public boolean hasPadding(final int slot){ return gui.getGuiItem(slot)!=null; }
    public boolean hasPadding(final int row, final int col){ return hasPadding(toSlot(row, col)); }
    public boolean hasPadding(InventoryClickEvent event){ return hasPadding(event.getSlot()); }
    ...
    public boolean hasItem(final int row, final int col){ return hasItem(toSlot(row, col)); }
    public boolean hasItem(InventoryClickEvent event){ return hasItem(event.getSlot()); }
    ...
    public ItemStack getItem(int row,int col) { return getItem(toSlot(row, col)); }
    public ItemStack getItem(InventoryClickEvent event) { return getItem(event.getSlot()); }
