...
public class WorkbenchGui extends CustomGui{
    ...
    public List<GuiButton> getButtons() { return buttons; }
    public void setButtons( List<GuiButton> newButtons) { buttons=newButtons; drawButtons(); }
    public GuiButton getButton() { return buttons.get(0); }
    public void setButton(GuiButton newButtons) { buttons.remove(buttons.size()-1); buttons.add(newButtons); drawButtons(); }
    public Consumer<InventoryClickEvent> getInputChangeAction() { return inputChangeAction; }
    public Consumer<InventoryClickEvent> getOutputGetAction() { return outputGetAction; }
    public Consumer<InventoryCloseEvent>  getGuiCloseAction() { return guiCloseAction; }
    public void setInputChangeAction(Consumer<InventoryClickEvent> consumer) { inputChangeAction=consumer; }
    public void setOutputGetAction(Consumer<InventoryClickEvent> consumer) { outputGetAction=consumer; }
    public void setGuiCloseAction(Consumer<InventoryCloseEvent> consumer) { guiCloseAction=consumer; }
    ...
    protected void closeEvent(InventoryCloseEvent event) {
        ...
        if(this.hasInputItem()) { list.addAll(this.getInputItems()); } //获取输入框所有物品
        if(this.hasOutputItem()) { list.addAll(this.getOutputItems()); } //获取输出框所有物品
