...
public final class CustomItemManagement extends ApiMember {
    ...
    public CustomItemManagement(ApiManagement apiManagement) {
        super(apiManagement);
    }
    ...
    //物品的自定义化
    public static void setItemData(ItemMeta meta, String id) {
        itemDataService.setItemData(meta, id);
    }

    public static void setTexture(ItemMeta meta, String id) {
        textureService.setTexture(meta, id);
    }


    //方块的自定义化
    public static boolean isTileEntity(Material type) {
        return blockDataService.isTileEntity(type);
    }

    public static void setBlockData(Block block, String id) {
        blockDataService.setBlockData(block, id);
    }
    ...
    public boolean hasId(String id) {
        if (customItemIds.isEmpty() || !customItemIds.contains(id)) {
            return false;
        }
        return true;
    }
